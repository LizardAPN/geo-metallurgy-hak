...
[Живое демо](http://111.88.148.105:5173/) · [Видео](<VIDEO_URL>) · [Презентация](docs/presentation.pdf)

## Попробовать за 30 секунд

Откройте [демо](http://111.88.148.105:5173/) (локально: http://localhost:5173) и вставьте один из запросов:
...
Для разработки отдельных модулей — [`Makefile`](Makefile)